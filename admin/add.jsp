...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-0" data-genuitec-path="/Blog/WebRoot/admin/add.jsp">
	<div class="head_line" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-0" data-genuitec-path="/Blog/WebRoot/admin/add.jsp"></div>

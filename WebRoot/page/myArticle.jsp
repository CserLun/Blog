	...
	<div class="container" id="main">
		...
		<div class="row c_center">
			<div class="col-md-3" id="left_content">
				...
				<div id="title">
					<h2>
						<a href="/Blog/index.jsp">&nbsp;</a>
					</h2>
					<h5 class="text-muted">春光不自留，莫怪东风恶。</h5>
				</div>
				...
				<div id="list">
					<table class="table table-hover c_center">
						...
						<tr>
							<td class="active"><a href="/Blog/MyArticleServlet"><span class="glyphicon  glyphicon-th-large"></span>
								&nbsp;&nbsp;我的</a></td>
						</tr>	
						<tr>
